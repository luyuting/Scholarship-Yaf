<?php
    class Comm_T {
        ...
        const TABLE_ADMIN = 'tb_admin';
        const TABLE_APPLY = 'tb_apply';
        const TABLE_AUDIT = 'tb_audit';
        const TABLE_ITEM_SCORE = 'tb_item_score';
        const TABLE_USER = 'tb_user';
        const TABLE_COMPETITION = 'tb_competition';
        const TABLE_WORK_SCORE = 'tb_work_score';
    }